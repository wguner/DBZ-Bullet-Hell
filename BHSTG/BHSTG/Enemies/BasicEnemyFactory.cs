...
namespace BHSTG.Enemies
{
    ...
    /// </summary>
    internal class BasicEnemyFactory : IEnemyFactory
    {
        ...
        {
            enemiesSpawned++;
            return new BasicEnemy(defaultPosition, ref enemyTexture, defaultHP, defaultAttackSpeed, ref projController, movement, attack);
        }
