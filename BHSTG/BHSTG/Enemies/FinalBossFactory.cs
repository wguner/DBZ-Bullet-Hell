...
{
    /// <summary>
    /// Factory to go along with the finalBoss class.
    /// </summary>
    internal class FinalBossFactory : IEnemyFactory
    {
        ...
        {
            enemiesSpawned++;
            return new FinalBoss(defaultPosition, ref enemyTexture, defaultHP, defaultAttackSpeed, ref projController, movement, attack);
        }
